...
gulp.task('js', () => {
  gulp.src([
      ...
      './src/js/parts/slick.min.js',
      './src/js/parts/slick-slaider.js',
      './src/js/parts/menu.js',
      './src/js/parts/parallax.min.js',
...
/* Task Build */
gulp.task('build', ['html', 'scss', 'css', 'js', 'image', 'fonts', 'htaccess']);
